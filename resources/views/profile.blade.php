      ...
      <div class="container px-5 py-24 mx-auto">
        ...
        @foreach ($articles as $article)
          <div class="p-12 md:w-1/2 flex flex-col items-start">
            <span class="inline-block py-1 px-2 rounded bg-blue-50 text-blue-500 text-xs font-medium tracking-widest">作成日{{ $article->created_at }}</span>
            ...
            <div class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
              <a href="{{ route('article.show', $article->id) }}" class="text-blue-500 inline-flex items-center">続きを読む
            ...
            <a class="inline-flex items-center">
              <img alt="logo" src=" {{$article->img_pass}}" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center">
            </a>
          </div>
          @endforeach
        </div>
